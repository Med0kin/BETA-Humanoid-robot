...
def importpos(filename):
    ...
    # remove /Servos from script_folder
    
    print("Script folder: ",script_folder[:-7])
    filepath = '/Positions/' + filename + '.txt'
    fileAbsPath = script_folder[:-7] + filepath
    # fileAbsPath = os.path.join(script_folder, filepath)
    print("File path: ", fileAbsPath)
...
class Servo:
    ...
    def tiktok(self):
        wykrok = ['start', 'tik1', 'tik2']
        act3 = ['pb1', 'default']
        powrot = ['tik1', 'start']
        self.setsequence(wykrok, 1.5)
        self.setsequence(act3, 5)
        self.setsequence(powrot, 1.5)
    ...
    def coreography(self):
        while self.choreographyswitch:
            if self.acrobations == "dance":
                ...
                mixer.music.load('Servos/jogging2.mp3')
                ...
                mixer.music.load('Servos/ballerina.mp3')
                mixer.music.set_volume(0.5)
                mixer.music.play()
                self.ballerina()
                self.acrobations = ""
            elif self.acrobations == "twist":
                mixer.music.load('Servos/twist.mp3')
                mixer.music.set_volume(0.5)
                mixer.music.play()
                self.twist()
                self.acrobations = ""
                ...
                mixer.music.load('Servos/hiphop.mp3')
                mixer.music.set_volume(0.5)
                mixer.music.play()
                self.hipHop()
                self.acrobations = ""
